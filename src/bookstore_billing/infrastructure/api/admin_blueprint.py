...
def __generate_users_data(session: Session = None) -> None:
    users = [
        User(
            id="e5e61e0d-9bf9-4e54-9d1e-7d4b4af1e7a3",
            username="johndoe123",
            first_name="Emily",
            last_name="Rodriguez",
        ...
        User(
            id="c3f4d9b9-037b-4b04-9e11-f2b37dc371a6",
            username="sarahsmith",
            first_name="Jacob",
            last_name="Kim",
        ...
        User(
            id="a593c421-7147-4b88-a32f-af200109a1bc",
        ...
        User(
            id="4f80b2cf-cb4c-4a4a-b9c9-7e24b918c224",
            username="katie88",
            first_name="William",
            last_name="Chen",
            email="amy.nguyen@yahoo.com",
            user_status=True,
        ),
        User(
            id="28d082e1-7ca7-4d72-b7e7-9c9b7f8256b9",
            username="markjones27",
            first_name="Natalie",
            last_name="Wong",
